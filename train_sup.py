...
class Trainer:
    ...
    def __init__(self, args, info):
        ...
        optimizer_grouped_parameters = [
            {'params': [p for n, p in self.model.named_parameters() if not any(nd in n for nd in no_decay) and not 'embeddings' in n], 'lr': self.args.initial_lr, 'weight_decay': self.args.weight_decay},
            {'params': [p for n, p in self.model.named_parameters() if any(nd in n for nd in no_decay) and not 'embeddings' in n], 'lr': self.args.initial_lr, 'weight_decay': 0.0},
        ]
        self.optimizer = optim.Adam(optimizer_grouped_parameters, eps=1e-8)
